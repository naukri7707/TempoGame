...
public struct Evaluation
{
    ...
    public static Evaluation Perfect { get; } = new Evaluation(3000, 32, 2, 40);

    public static Evaluation Great { get; } = new Evaluation(2000, 16, 1, 70);

    public static Evaluation Good { get; } = new Evaluation(1000, 8, -1, 100);

    public static Evaluation Bad { get; } = new Evaluation(500, 4, -2, 200);
